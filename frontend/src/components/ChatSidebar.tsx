...
const ChatSidebar = ({
   ...
   return (
    <aside className={`fixed z-20 sm:static top-0 left-0 h-screen w-80 bg-grey-900 border-r border-gray-700 transform ${
        sidebarOpen?"translate-x-0": "translate-x-full"
    } sm:translate-x-0 translation-transform duration-300 flex flex-col`}>
        {/*header*/}
